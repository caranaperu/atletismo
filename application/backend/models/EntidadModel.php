...
class EntidadModel extends \app\common\model\TSLAppCommonBaseModel {
    ...
    protected $entidad_titulo_alterno;
    protected $entidad_siglas;
    protected $entidad_direccion;
    protected $entidad_web_url;
    protected $entidad_correo;
    protected $entidad_telefonos;
    protected $entidad_fax;
    protected $entidad_eslogan;
    ...
    /**
     * Retorna un nombre alterno en el caso que la razon social difiera
     * de la comercial.
     *
     * @return string con el titulo alterno
     */
    public function get_entidad_titulo_alterno() {
        return $this->entidad_titulo_alterno;
    }

    public function get_entidad_siglas() {
        return $this->entidad_siglas;
    }
    ...
    public function get_entidad_web_url() {
        return $this->entidad_web_url;
    }
    ...
    public function get_entidad_eslogan() {
        return $this->entidad_eslogan;
    }
    ...
    /**
     * Setea un nombre alterno en el caso que la razon social difiera
     * de la comercial.
     *
     * @param string $entidad_razon_social con el titulo alterno
     */
    public function set_entidad_titulo_alterno($entidad_titulo_alterno) {
        $this->entidad_titulo_alterno = $entidad_titulo_alterno;
    }

    public function set_entidad_siglas($entidad_siglas) {
        $this->entidad_siglas = $entidad_siglas;
    }
    ...
    public function set_entidad_web_url($entidad_web_url) {
        $this->entidad_web_url = $entidad_web_url;
    }
    ...
    public function set_entidad_eslogan($entidad_eslogan) {
        $this->entidad_eslogan = $entidad_eslogan;
    }
