...
/*
  ...
  |
 */
$config['base_url'] = 'http://localhost/atletismo/';
...
function __autoload($class) {
    ...
    } else if (strstr($class, 'ModelTraits')) {
        include_once(APPPATH . 'models/' . $class . '.php');
    } else if (strstr($class, 'BussinessService')) {
        include_once(APPPATH . 'bussiness/' . $class . '.php');
    } else if (strstr($class, 'Controller')) {
        if (strstr($class, 'reports')) {
            include_once(APPPATH . 'controllers/reports/' . $class . '.php');
        } else {
