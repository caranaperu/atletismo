    ...
    protected function setupData() {
        ...
        $this->setupOpts = [
            ...
            "paramsList" => [
                ...
                "add" => ['competencias_pruebas_id', 'atletas_codigo', 'atletas_resultados_resultado', 'atletas_resultados_puesto',
                    'atletas_resultados_puntos','atletas_resultados_viento','activo'],
                "del" => ['atletas_resultados_id', 'versionId'],
                "upd" => ['atletas_resultados_id', 'competencias_pruebas_id', 'atletas_codigo', 'atletas_resultados_resultado',
