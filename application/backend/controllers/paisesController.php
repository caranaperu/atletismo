    ...
    protected function setupData() {
        ...
        $this->setupOpts = [
            ...
            "paramsList" => [
                ...
                "add" => ['paises_codigo', 'paises_descripcion', 'paises_entidad', 'regiones_codigo','activo'],
                "del" => ['paises_codigo', 'versionId'],
                "upd" => ['paises_codigo', 'paises_descripcion', 'paises_entidad', 'regiones_codigo','versionId','activo'],
            ],
