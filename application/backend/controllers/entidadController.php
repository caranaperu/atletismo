    ...
    protected function setupData() {
        ...
        $this->setupOpts = [
            ...
            "paramsList" => [
                ...
                "add" => ['entidad_razon_social', 'entidad_ruc', 'entidad_direccion', 'entidad_siglas', 'entidad_eslogan', 'entidad_titulo_alterno', 'entidad_telefonos', 'entidad_fax', 'entidad_web_url', 'entidad_correo', 'activo'],
                "del" => ['entidad_id', 'versionId'],
                "upd" => ['entidad_id', 'entidad_razon_social', 'entidad_ruc', 'entidad_direccion', 'entidad_siglas', 'entidad_eslogan', 'entidad_titulo_alterno', 'entidad_telefonos', 'entidad_fax', 'entidad_web_url', 'entidad_correo', 'versionId', 'activo'],
            ],
