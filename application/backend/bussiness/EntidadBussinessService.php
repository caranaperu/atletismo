...
class EntidadBussinessService extends \app\common\bussiness\TSLAppCRUDBussinessService {
    ...
    protected function &getModelToAdd(\TSLIDataTransferObj $dto) {
        ...
        $model->set_entidad_siglas($dto->getParameterValue('entidad_siglas'));
        $model->set_entidad_eslogan($dto->getParameterValue('entidad_eslogan'));
        $model->set_entidad_titulo_alterno($dto->getParameterValue('entidad_titulo_alterno'));
