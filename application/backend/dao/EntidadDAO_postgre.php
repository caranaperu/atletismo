...
class EntidadDAO_postgre extends \app\common\dao\TSLAppBasicRecordDAO_postgre {
    ...
    protected function getAddRecordQuery(\TSLDataModel &$record,\TSLRequestConstraints &$constraints=NULL) {
        ...
        $sql = 'insert into tb_entidad (entidad_razon_social,entidad_ruc,entidad_titulo_alterno,entidad_direccion,entidad_web_url,' .
                ...
                '\'' . $record->get_entidad_titulo_alterno() . '\',' .
                '\'' . $record->get_entidad_direccion() . '\',' .
                '\'' . $record->get_entidad_web_url() . '\',' .
                '\'' . $record->get_entidad_telefonos() . '\',' .
                '\'' . $record->get_entidad_fax() . '\',' .
                '\'' . $record->get_entidad_eslogan() . '\',' .
                '\'' . $record->get_entidad_siglas() . '\',' .
    ...
    protected function getFetchQuery(\TSLDataModel &$record = NULL, \TSLRequestConstraints &$constraints = NULL, $subOperation = NULL) {
        ...
        $sql = 'select entidad_id,entidad_razon_social,entidad_ruc,entidad_titulo_alterno,entidad_direccion,entidad_web_url,' .
                'entidad_telefonos,entidad_fax,entidad_eslogan,entidad_siglas,entidad_correo,activo,xmin as "versionId" from  tb_entidad LIMIT 1';
        return $sql;
    }
    ...
    protected function getRecordQueryByCode($code) {
        return 'select entidad_id,entidad_razon_social,entidad_ruc,entidad_titulo_alterno,entidad_direccion,entidad_web_url,' .
                'entidad_telefonos,entidad_fax,entidad_eslogan,entidad_siglas,entidad_correo,activo,xmin as "versionId" from tb_entidad where "entidad_id" = ' .
                ($code === NULL ? 'null' : $code);
    }
    ...
    protected function getUpdateRecordQuery(\TSLDataModel &$record) {
        $sql = 'update tb_entidad set entidad_razon_social=\'' . $record->get_entidad_razon_social() . '\'' .
                ...
                ',entidad_web_url=\'' . $record->get_entidad_web_url() . '\'' .
                ',entidad_telefonos=\'' . $record->get_entidad_telefonos() . '\'' .
                ',entidad_fax=\'' . $record->get_entidad_fax() . '\'' .
                ',entidad_eslogan=\'' . $record->get_entidad_eslogan() . '\'' .
                ',entidad_siglas=\'' . $record->get_entidad_siglas() . '\'' .
