...
class UnidadMedidaDAO_postgre extends \app\common\dao\TSLAppBasicRecordDAO_postgre {
    ...
    protected function getAddRecordQuery(\TSLDataModel &$record, \TSLRequestConstraints &$constraints = NULL) {
        ...
        return 'insert into tb_unidad_medida (unidad_medida_codigo,unidad_medida_descripcion,unidad_medida_regex_e,unidad_medida_regex_m,'
        . 'unidad_medida_tipo,activo,usuario) values(\'' .
                $record->get_unidad_medida_codigo() . '\',\'' .
                $record->get_unidad_medida_descripcion() . '\',\'' .
                $record->get_unidad_medida_regex_e() . '\',\'' .
                $record->get_unidad_medida_regex_m() . '\',\'' .
    ...
    protected function getFetchQuery(\TSLDataModel &$record = NULL, \TSLRequestConstraints &$constraints = NULL, $subOperation = NULL) {
        ...
        $sql = 'select unidad_medida_codigo,unidad_medida_descripcion,unidad_medida_regex_e,unidad_medida_regex_m,unidad_medida_tipo,unidad_medida_protected,activo,xmin as "versionId" from  tb_unidad_medida ';
    ...
    protected function getRecordQueryByCode($code) {
        return 'select unidad_medida_codigo,unidad_medida_descripcion,unidad_medida_regex_e,unidad_medida_regex_m,unidad_medida_tipo,unidad_medida_protected,activo,' .
    ...
    protected function getUpdateRecordQuery(\TSLDataModel &$record) {
        ...
        return 'update tb_unidad_medida set unidad_medida_codigo=\'' . $record->get_unidad_medida_codigo() . '\','.
                ...
                'unidad_medida_regex_e=\'' . $record->get_unidad_medida_regex_e() . '\',' .
                'unidad_medida_regex_m=\'' . $record->get_unidad_medida_regex_m() . '\',' .
