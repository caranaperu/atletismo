 ...
 * @since   06-FEB-2013
 * @version $Id: EntidadDAO_mssql.php 208 2014-06-23 22:48:07Z aranape $
 * @history ''
 *
 * $Date: 2014-06-23 17:48:07 -0500 (lun, 23 jun 2014) $
 * $Rev: 208 $
 */
class EntidadDAO_mssql extends \app\common\dao\TSLAppBasicRecordDAO_postgre {
    ...
    protected function getFetchQuery(\TSLDataModel &$record = NULL, \TSLRequestConstraints &$constraints = NULL, $subOperation = NULL) {
        ...
        $sql = 'select TOP 1 entidad_id,entidad_razon_social,entidad_ruc,entidad_direccion,' .
                'entidad_telefonos,entidad_fax,entidad_correo,activo,xmin as "versionId" from  tb_entidad';
        return $sql;
    }
