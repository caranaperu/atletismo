 ...
 * la edicion de los registros de Procedimientos y sus
    ...
    createForm: function (formMode) {
        ...
        return isc.DynamicFormExt.create({
            ...
            fields: [
                ...
                {name: "prm_copyFromPerfil", title: 'Copiar desde otro perfil', editorType: "comboBoxExt", length: 50, width: "200", showPending: true,
                    valueField: "perfil_id", displayField: "perfil_descripcion",
                    optionDataSource: mdl_perfil,
                    pickListFields: [{name: "sys_systemcode", width: '20%'}, {name: "perfil_codigo", width: '20%'}, {name: "perfil_descripcion", width: '60%'}],
                    pickListWidth: 300,
                    completeOnTab: true,
