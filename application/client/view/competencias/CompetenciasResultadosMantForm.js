...
isc.WinCompetenciasResultadosMantForm.addProperties({
    ...
    joinKeyFields: [{fieldName: 'competencias_pruebas_id', fieldValue: ''}],
    ...
    createForm: function(formMode) {
        return isc.DynamicFormExt.create({
            ...
            fields: [
                {name: "competencias_codigo", type: 'staticText', endRow: true, colSpan: 8, width: "*",
                    formatValue: function(value, record, form, item) {
                        return formCompetenciasPruebasResultadosMantForm._vcache_competencias_descripcion_visual;
                    }
                },
                {name: "pruebas_codigo", editorType: "comboBoxExt", width: "250",
                        ...
                        if (filter.pruebas_descripcion) {
                            filter = {_constructor: "AdvancedCriteria",
                                operator: "and", criteria: [
                                    ...
                                    {fieldName: 'competencias_codigo', operator: 'equals', value: competenciaCodigo}
                                ]};
                        } else { // CASO NO EXISTE NADA DIGITADO.
                            // En modo edit buscamos en gorma exacta el codigo
                            if (formCompetenciasPruebasResultadosMantForm.formMode == 'edit') {
                                filter = {_constructor: "AdvancedCriteria",
                                    operator: "and", criteria: [
                                        {fieldName: "pruebas_codigo", operator: "equals", value: this.getValue()},
                                        {fieldName: 'competencias_codigo', operator: 'equals', value: competenciaCodigo}
                                    ]};
                            } else {
                    ...
                    change: function(form, item, value, oldValue) {
                        ...
                        if (value.getTime() > formCompetenciasPruebasResultadosMantForm._vcache_competencias_fecha_final.getTime() || value.getTime() < formCompetenciasPruebasResultadosMantForm._vcache_competencias_fecha_inicio.getTime()) {
                            isc.say('La fecha debe estar dentro de las fechas en que se realizo la competencia, <br>Del ' +
                                    formCompetenciasPruebasResultadosMantForm._vcache_competencias_fecha_inicio.toLocaleDateString() +
                ...
                {defaultValue: "Datos y Observaciones", type: "section", colSpan: 8, width: "*", canCollapse: false, align: 'center',
                ...
                {name: "competencias_pruebas_viento", length: 12, width: '50', textAlign: 'right', endRow: true},
                ...
                {name: "competencias_pruebas_id", visible: false, defaultValue: null},
                {name: "competencias_pruebas_origen_id", visible: false, defaultValue: null}
            ],
            ...
            editSelectedData: function(component) {
                ...
                if (formCompetenciasPruebasResultadosMantForm._vcache_pruebas_codigo != record.pruebas_codigo) {
                    cambios = true;
                }
                ...
                if (cambios == true) {
                    formCompetenciasPruebasResultadosMantForm.getItem('pruebas_codigo').fetchData(function(it, resp, data, req) {
                        formCompetenciasPruebasResultadosMantForm._updateMarcasFieldsStatus(formCompetenciasPruebasResultadosMantForm.getItem('pruebas_codigo').getSelectedRecord(), false, false);
            ...
            canShowTheDetailGrid: function(mode) {
                // console.log(formCompetenciasPruebasResultadosMantForm._apppruebas_multiple);
                if (mode == 'add') {
            ...
            __updateMarcasFieldsStatus: function(pruebaChanged, clearResultado, unidad_medida_tipo, unidad_medida_regex_e, unidad_medida_regex_m, apppruebas_verifica_viento, apppruebas_viento_individual) {
                ...
                //    console.log(apppruebas_verifica_viento)
                //    console.log(apppruebas_viento_individual)
    ...
    createDetailGridContainer: function(mode) {
        return isc.DetailGridContainer.create({
            ...
            gridProperties: {
                ...
                fields: [
                    {name: "atletas_codigo", editorType: "comboBoxExt",
                                ...
                                if (filter.atletas_nombre_completo) {
                                    filter = {_constructor: "AdvancedCriteria",
                                        operator: "and", criteria: [
                                            ...
                                            {fieldName: 'atletas_sexo', operator: 'equals', value: record_prueba.pruebas_sexo}
                                        ]};
                                } else {
                                    filter = {_constructor: "AdvancedCriteria",
                                        operator: "and", criteria: [
                    ...
                    {name: "atletas_resultados_viento", align: 'right'},
                    {name: "atletas_resultados_puntos", align: 'right', defaultValue: 0},
                    {name: "atletas_resultados_puesto", align: 'right'}
                ],
                ...
                editComplete: function(rowNum, colNum, newValues, oldValues, editCompletionEvent, dsResponse) {
                    ...
                    // reforzamos el sort.
                    g_atletas_resultados.setSort([{property: 'atletas_resultados_puesto'}]);
                }
            }});
    },
    canShowTheDetailGrid: function(mode) {
