 ...
 *
 * 2) Para el caso de modo editar en cualquier caso es suficiente el override de postSetFieldsToEdit()
 * ya que en ese punto todos los datos estan cargados.
 *
...
isc.WinAppPruebasForm.addProperties({
    ...
    createForm: function(formMode) {
        return isc.DynamicFormExt.create({
            ...
            focusInEditFld: 'apppruebas_descripcion',
            // campos viruales
            _pruebas_clasificacion_descripcion: undefined,
            _unidad_medida_codigo: undefined,
            fields: [
                {name: "apppruebas_codigo", type: "text", width: "110", mask: ">AAAAAAAAAAAA"},
                {name: "apppruebas_descripcion", length: 150, width: "220"},
                {name: "pruebas_clasificacion_codigo", editorType: "comboBoxExt", length: 50, width: "180",
                    valueField: "pruebas_clasificacion_codigo", displayField: "pruebas_clasificacion_descripcion",
                    pickListFields: [{name: "pruebas_clasificacion_codigo", width: '20%'}, {name: "pruebas_clasificacion_descripcion", width: '80%'}],
                    pickListWidth: 240,
                ...
                {name: "apppruebas_multiple", defaultValue: false,
                    changed: function(form, item, value) {
                        var record = formAppPruebas.getItem('pruebas_clasificacion_codigo').getSelectedRecord();
                        formAppPruebas._setPruebasDependantsStatus(record);
                    }
                },
                {defaultValue: "Limites", type: "section", width: "*", canCollapse: false, align: 'center',
                ...
                {name: "apppruebas_marca_menor", textAlign: 'right', length: 12, width: 80,
                    validators: [
                        {type: "regexp", expression: '^$', errorMessage: 'Formato de la Marca invalido para la prueba'},
                        {type: "marcaMenorCheck",
                ...
                {name: "apppruebas_marca_mayor", textAlign: 'right', length: 12, width: 80,
                    validators: [
                        {type: "regexp", expression: '^$', errorMessage: 'Formato de la Marca invalido para la prueba'},
                        {type: "marcaMayorCheck",
                            // Valida que la marca mayor no sea menor o igual que la inicial
                            // dado que en este momento se tratan como string normalizamos y comparamos
                            condition: function(item, validator, value) {
                ...
                {name: 'apppruebas_factor_manual', defaultValue: "0.00", width: 60, textAlign: 'right'},
                {name: "apppruebas_verifica_viento", defaultValue: false, redrawOnChange: true,
                    // Si hay cambios se afecta su campo relacionado donde se coloca
                ...
                {name: "apppruebas_viento_individual", defaultValue: false, redrawOnChange: true},
                {name: "apppruebas_viento_limite_normal", width: 60, textAlign: 'right',
                    validators: [{
                            type: "requiredIf",
                ...
                {name: "apppruebas_viento_limite_multiple", width: 60, textAlign: 'right'},
                {name: 'apppruebas_nro_atletas', defaultValue: "1", width: 60, textAlign: 'right'}
            ],
