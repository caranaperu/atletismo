...
isc.WinPruebasClasificacionForm.addProperties({
    ...
    createForm: function(formMode) {
        return isc.DynamicFormExt.create({
            ...
            fields: [
                {name: "pruebas_clasificacion_codigo", title: "Codigo", type: "text", width: "80", mask: ">AAAAAAAA"},
                {name: "pruebas_clasificacion_descripcion", title: "Descripcion", length: 120, width: "260"},
                {name: "pruebas_tipo_codigo", title: "Tipo", editorType: "comboBoxExt", length: 80, width: "280",
                ...
                {name: "unidad_medida_codigo", title: "Medida", editorType: "comboBoxExt", length: 80, width: "280",
