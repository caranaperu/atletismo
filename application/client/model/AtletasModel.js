...
isc.RestDataSource.create({
    ...
    fields: [
        ...
        {name: "atletas_nro_pasaporte", title: "Pasaporte", mask: '########', validators: [{type: "lengthRange", min: 7, max: 8}]},
        {name: "atletas_fecha_nacimiento", title: "Fec.Nacimiento", type: 'date', required: true},
        {name: "atletas_agno", title: "A&ntildeo", type: 'integer', required: false},
        {name: "atletas_telefono_casa", title: "Tlf.Casa", mask: glb_MSK_phone, validators: [{type: "lengthRange", min: 7, max: 13}]},
        {name: "atletas_telefono_celular", title: "Tlf.Celular", mask: glb_MSK_phone, validators: [{type: "lengthRange", min: 9, max: 13}]},
        {name: "atletas_email", title: "E-Mail", validators: [{type: "lengthRange", max: 150}, {type: "regexp",
                    expression: glb_RE_email}]},
        {name: "atletas_direccion", title: "Direccion", required: true, validators: [{type: "lengthRange", max: 250}]},
        {name: "atletas_observaciones", title: "Observaciones", validators: [{type: "lengthRange", max: 250}]},
        {name: "atletas_talla_ropa_buzo", title: "Talla Buzo", valueMap: ["XS", "S", "M", "L", "XL", "XXL", "XXL", "??"], required: true},
        {name: "atletas_talla_ropa_poloshort", title: "Talla Polo/Short", valueMap: ["XS", "S", "M", "L", "XL", "XXL", "XXL", "??"], required: true},
        {name: "atletas_talla_zapatillas", title: "Talla Zapatillas", required: false, type: 'float', validators: [{type: "floatRange", min: 4, max: 50}, {type: "floatPrecision", precision: 2}]},
        {name: "atletas_norma_zapatillas", title: "Norma", valueMap: ["UK", "US", "NM", "??"], required: true},
        {name: "atletas_url_foto", title: "URL foto", required: false, validators: [{type: "lengthRange", max: 300}]}
    ],
    fetchDataURL: glb_dataUrl + 'atletasController?op=fetch&libid=SmartClient',
    addDataURL: glb_dataUrl + 'atletasController?op=add&libid=SmartClient',
    updateDataURL: glb_dataUrl + 'atletasController?op=upd&libid=SmartClient',
    removeDataURL: glb_dataUrl + 'atletasController?op=del&libid=SmartClient',
    operationBindings: [
