...
isc.RestDataSource.create({
    ...
    fields: [
        ...
        {name: "entidad_siglas", title: "Siglas",
            validators: [{type: "regexp", expression: glb_RE_onlyValidText},{type: "lengthRange", max: 15}]
        },
        {name: "entidad_direccion", title: "Direccion", required: true,
            validators: [{type: "lengthRange", max: 300}]
        },
        {name: "entidad_titulo_alterno", title: "Titulo Alterno", validators: [{type: "lengthRange", max: 200}]},
        {name: "entidad_web_url", title: "Pagina Web",validators: [{type: "regexp", expression: glb_RE_url},{type: "lengthRange", max: 200}]},
        ...
        {name: "entidad_eslogan", title: "Eslogan", validators: [{type: "lengthRange", max: 250}]}
    ],
